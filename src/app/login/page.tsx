...
export default function LoginPage() {
  return (
      <div className="flex flex-wrap overflow-hidden gap-5  w-full py-10">
        ...
        <div className="relative w-[60%] bg-gradient-to-r from-[#DFFCF5] to-[#C5F9EC] flex items-center justify-center rounded-tr-[50px] rounded-br-[50px]">
          <div className="text-center">
            <img
              src="/images/landing.png" // Replace with your actual image path
